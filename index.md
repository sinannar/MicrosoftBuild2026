...
| 10:45 AM | 3:45 PM | [BRK241](2026-06-03/BRK241.md) | From prototype to production: build and run agents at scale | Breakout | 300 |
...
| DEM333 | How Foundry integrates with open-source frameworks and tools | BRK241 | Agent Framework + LangGraph + MCP + A2A |
...
| TT656 | From Locked-In to Liquid: Modernizing .NET Before November 2026 EOL | BRK241 | .NET 8/9 EOL migration strategies |
